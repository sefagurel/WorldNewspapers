 ...
 */
package com.sefagurel.worldnewspapers.viewpagerindicator;
...
import com.sefagurel.worldnewspapers.R;
...
public class LinePageIndicator extends View implements PageIndicator {
	...
	static class SavedState extends BaseSavedState {
		...
		@SuppressWarnings("UnusedDeclaration") public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
			@Override
